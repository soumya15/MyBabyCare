package babycare.android.scu.edu.mybabycare.sleepguide.VoiceIdent.mcm.smc.wav;
 ...
 * .3gpp file using the AMR-NB codec when recording with the default {@link android.media.MediaRecorder}).
 * 
...
public class WaveRecorder
{
	...
	/** Recorder state, see {@link babycare.android.scu.edu.mybabycare.sleepguide.VoiceIdent.mcm.smc.wav.WaveRecorder.State}. */
	private State state;
	...
	/** Audio source, {@link android.media.MediaRecorder.AudioSource}. */
	private int audioSource;
	/** {@link android.media.AudioFormat}. */
	...
	/**
	 * Default constructor. Leaves the recorder in {@link babycare.android.scu.edu.mybabycare.sleepguide.VoiceIdent.mcm.smc.wav.WaveRecorder.State#INITIALIZING}, except if some kind
	 * of error happens.
	 * 
	 * @param sampleRate
	 *            Audio sampling rate.
	...
	/**
	 * Sets the output file for the recorder, call in {@link babycare.android.scu.edu.mybabycare.sleepguide.VoiceIdent.mcm.smc.wav.WaveRecorder.State#INITIALIZING} , right after
	 * constructing.
	 * 
	 * @param path
